      ...
      <div class="home">
        ...
        <div class="home_information">
            ...
            <ul class="home_information_list">
                ...
                <li class="home_information_list_item"><span><?php echo $home['beds']?> Gäste</span></li>
           ...
           <a class="btn home_information_detail_btn" href="./views/home_detail.php?home_id=<?php echo $home['home_id'];?>&user_id=<?php echo $home['user_id'];?>">Details ansehen</a>
