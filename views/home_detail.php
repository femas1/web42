...
<main class="main-container">
  ...
  <?php foreach($home_values as $home_value){ ?>
    ...
    <div class="house">
        ...
        <div class="house_information">
            ...
            <ul class="house_information_list">
                <li
                  class="house_information_list_item"
                >
                <span><?php echo $home_value['name']?></span>
              </li>
                <li class="house_information_list_item"><span><?php echo $home_value['location']?></span></li>
                <li class="house_information_list_item"><span><?php echo $home_value['size']?>m²</span></li>
                <li class="house_information_list_item"><span><?php echo $home_value['beds']?> Gäste</span></li>
                <li class="house_information_list_item"><span>€ <?php echo $home_value['price']?> pro Nacht</span></li>
                <li class="house_information_list_item"><span>Gastgeber: <a href="../views/user_detail.php?user_id=<?php echo $home_value['user_id']?>"><?php echo $user["user_name"]?> </a></span></li>
            </ul>
    ...
    <button class="btn house_edit_btn">
